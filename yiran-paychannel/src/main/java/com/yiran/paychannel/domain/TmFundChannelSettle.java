...
public class TmFundChannelSettle extends BaseEntity {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("settleId", getSettleId())
				.append("fundChannelCode", getFundChannelCode()).append("contractNo", getContractNo())
				.append("merchantNo", getMerchantNo()).append("accountNo", getAccountNo())
				.append("accountName", getAccountName()).append("settleMode", getSettleMode())
				.append("settleCycle", getSettleCycle()).append("clearingFileMode", getClearingFileMode())
				.append("enable", getEnable()).append("gmtCreate", getGmtCreate())
