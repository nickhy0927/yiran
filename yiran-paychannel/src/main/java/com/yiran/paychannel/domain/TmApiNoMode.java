...
public class TmApiNoMode extends BaseEntity {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("apiNoModeId", getApiNoModeId())
				.append("genPattern", getGenPattern()).append("seqName", getSeqName())
