...
public class TmFundChannelApiParam extends BaseEntity {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("paramId", getParamId())
				.append("apiCode", getApiCode()).append("paramName", getParamName())
				.append("paramCodeKey", getParamCodeKey()).append("paramDesc", getParamDesc())
				.append("nullAble", getNullAble()).append("enable", getEnable()).append("isSave", getIsSave())
				.append("isOrgin", getIsOrgin()).append("scene", getScene()).append("gmtCreate", getGmtCreate())
				.append("gmtModified", getGmtModified()).append("isChannelTrans", getIsChannelTrans())
				.append("transCode", getTransCode()).append("extension", getExtension()).toString();
	}
}
