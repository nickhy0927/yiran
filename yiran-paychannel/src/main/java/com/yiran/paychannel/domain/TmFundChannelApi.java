...
public class TmFundChannelApi extends BaseEntity {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("apiCode", getApiCode())
				.append("fundChannelCode", getFundChannelCode()).append("apiType", getApiType())
				.append("apiVersion", getApiVersion()).append("apiMethod", getApiMethod()).append("apiUri", getApiUri())
				.append("apiPriority", getApiPriority()).append("secure", getSecure()).append("maxItem", getMaxItem())
				.append("commTitleTemplate", getCommTitleTemplate())
				.append("commContentTemplate", getCommContentTemplate())
				.append("checkParseScript", getCheckParseScript()).append("resultParseScript", getResultParseScript())
				.append("needConfirm", getNeedConfirm()).append("enables", getEnables())
				.append("gmtCreate", getGmtCreate()).append("gmtModified", getGmtModified()).append("memo", getMemo())
				.append("apiNoModeId", getApiNoModeId()).append("apiSecurityId", getApiSecurityId())
				.append("consumeTime", getConsumeTime()).append("fileType", getFileType())
				.append("filePath", getFilePath()).append("apiName", getApiName())
				.append("needSyncGlide", getNeedSyncGlide()).append("extension", getExtension())
				.append("paramList", getParamList()).toString();
	}
