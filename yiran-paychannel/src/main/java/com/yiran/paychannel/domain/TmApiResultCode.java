...
public class TmApiResultCode extends BaseEntity {
	 ...
	 * @param subCode
	 */
	public TmApiResultCode(String fundChannelCode, String apiType, String resultCode, String resultSubCode) {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("apiResultCodeId", getApiResultCodeId())
				.append("fundChannelCode", getFundChannelCode()).append("apiType", getApiType())
				.append("resultCode", getResultCode()).append("resultSubCode", getResultSubCode())
				.append("expression", getExpression()).append("descriptionTemplate", getDescriptionTemplate())
				.append("unityResultCode", getUnityResultCode()).append("orderStatus", getOrderStatus())
				.append("useMapping", getUseMapping()).append("gmtCreate", getGmtCreate())
				.append("gmtModified", getGmtModified()).append("memo", getMemo()).toString();
	}
}
