...
public class TmUnityResultCode extends BaseEntity {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("unityResultCode", getUnityResultCode())
				.append("descriptionTemplate", getDescriptionTemplate()).append("gmtCreate", getGmtCreate())
