...
public class TmFundChannelExt extends BaseEntity {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("extId", getExtId())
				.append("fundChannelCode", getFundChannelCode()).append("attrKey", getAttrKey())
				.append("attrValue", getAttrValue()).append("attrType", getAttrType())
				.append("valueType", getValueType()).append("valueSplit", getValueSplit())
				.append("gmtCreate", getGmtCreate()).append("gmtModified", getGmtModified()).append("memo", getMemo())
				.append("attrCodeKey", getAttrCodeKey()).append("apiCode", getApiCode())
				.append("needMatch", getNeedMatch()).append("matchType", getMatchType()).toString();
	}
}
